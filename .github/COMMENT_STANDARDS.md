# Comment Standards for BetterSantaCruz

This document outlines the standardized comment format used throughout the BetterSantaCruz codebase.
 ...
 * @example
 * ```tsx
 * const weather = await fetchWeather('Sample Municipality');
 * ```
 */
```
