...
- Civic-data validation, 401 unit tests, lint, TypeScript, Prettier, the production build, and the 11-test browser smoke suite are green for the current feature slice.
...
- The source ledger now supports municipality, evidence-status, and text filters without mutating source records.
