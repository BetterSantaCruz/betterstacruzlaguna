...
These leads are intentionally not public civic facts. Each must be independently re-checked before promotion.

- `https://santacruzkayanatin.ph` was listed as a Santa Cruz, Laguna portal lead but was unreachable during the 2026-09-04 check.
- `https://sbstacruz.com/aboutUs` reports 26 barangays and approximately 3,860 hectares, but its `Lumban Logo` branding anomaly requires corroboration.
...
- DTI CMCI and PSA PSGC URLs are authoritative but were access-restricted during the research pass.
