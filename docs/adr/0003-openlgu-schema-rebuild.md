...
This ADR describes the reusable schema only. It does not authorize a remote
migration or import of inherited BetterLB data into BetterSantaCruz.
...
1. Export the explicitly reviewed target named by the operator; no database
