...
- Current local QA is green for civic-data validation, 399 unit tests, lint, TypeScript, Prettier, the production build, and the 11-test Santa Cruz browser smoke boundary. Re-run these gates after each feature slice; the broader inherited E2E files remain retained architecture/reference coverage.
