...
This directory contains automation, maintenance, and build scripts for BetterSantaCruz.
...
**Usage:**
```bash
python scripts/merge_services.py
```
...
```json
{
  "scripts": {
    ...
    "merge:data": "python scripts/merge_services.py"
  }
}
```
