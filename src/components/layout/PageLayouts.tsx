 ...
 * Matches the portal header style while keeping the project identity local.
 */
...
export function PageHero({
  ...
  return (
    <header className='animate-in fade-in flex flex-col justify-center py-8 text-center duration-700 md:py-12'>
      ...
      {description && (
        <p className='text-kapwa-text-support mx-auto max-w-2xl text-sm leading-relaxed md:text-base'>
          {description}
        </p>
      )}
      {metadata && (
 ...
 * Uses the shared semantic surface and heading tokens.
 */
