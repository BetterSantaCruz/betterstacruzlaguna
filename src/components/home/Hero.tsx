...
const Hero: FC = () => {
  ...
  const quickAccessCards: QuickAccessCard[] = [
    {
      title: 'Source ledger',
      description: 'See evidence and verification states',
      to: '/sources',
      icon: <FileSearchIcon className='h-6 w-6' />,
    },
    {
      title: 'Data gaps',
      description: 'Know what is not ready yet',
      to: '/about',
      icon: <ShieldCheckIcon className='h-6 w-6' />,
    },
    {
      title: 'Research context',
      description: 'Read the project boundaries',
      to: '/about',
      icon: <BookOpenIcon className='h-6 w-6' />,
    },
    {
      title: 'Contribute',
      description: 'Share a public source or correction',
      to: '/contribute',
      icon: <HandHelpingIcon className='h-6 w-6' />,
    },
  ];
      ...
      <div className='container px-4 mx-auto'>
        <div className='grid grid-cols-1 gap-8 items-center lg:grid-cols-2'>
          <div className='animate-fade-in'>
            ...
            <p className='mb-8 max-w-lg text-kapwa-text-inverse/90 kapwa-body-md-default'>
              {t('hero.subtitle')}
            </p>
            <p className='border-kapwa-border-inverse/40 bg-kapwa-bg-surface/10 mb-6 max-w-lg rounded-xl border p-3 text-sm text-kapwa-text-inverse'>
              Independent community project · local facts require source review
            </p>
