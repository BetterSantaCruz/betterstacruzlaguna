...
const ServicesSection: FC = () => {
  ...
  // Calculate service count per category before the empty-state branch so the
  // hook order remains stable if verified data is added later.
    ...
    return (
      <section className='bg-kapwa-bg-surface py-12'>
        <div className='container mx-auto px-4'>
          ...
          <DataStatus
            message="No Santa Cruz service records are published yet. A current official Citizens' Charter or equivalent primary source is required before requirements, fees, or processing times are shown."
            sourceHref='/sources'
          />
        </div>
      </section>
