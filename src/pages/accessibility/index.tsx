        ...
        <SectionBlock title='Feedback and Support' icon={MailIcon}>
          <div className='mx-auto max-w-4xl'>
            <p className='text-kapwa-text-support mb-6 text-lg'>
              If you hit an accessibility barrier on {config.portal.name},{' '}
              {config.portal.contactEmail
                ? 'email us and include the page URL, what you tried, and the assistive technology you use if you can.'
                : 'the project does not yet have a verified public support email. Record the page URL and issue while a support channel is being prepared.'}
            </p>

            {config.portal.contactEmail ? (
              <div className='border-kapwa-border-weak bg-kapwa-bg-surface max-w-lg rounded-lg border p-6'>
                <div className='mb-4 flex items-center'>
              ...
              <DataStatus
                title='Accessibility support channel not published yet'
                message='No verified public contact email is configured. Review the source ledger for the current project status and use the contribution channel when one is published.'
                sourceHref='/sources'
              />
            )}
          </div>
