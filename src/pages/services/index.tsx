...
export default function ServicesPage() {
  ...
  if (filteredServices.length === 0) {
    return (
      <DataStatus
        title='No Santa Cruz services are published yet'
        message="This is not evidence that no services exist. A current official Citizens' Charter or equivalent source must be reviewed before requirements, fees, or processing times are shown."
        sourceHref='/sources'
      />
    );
  }
