        ...
        <aside className='w-full space-y-6 xl:w-80'>
          ...
          <Card hover={false} className='space-y-4'>
            ...
            {config.portal.githubUrl ? (
              ...
              <DataStatus
                title='Contribution channel not published yet'
                message='This service record has no verified public edit channel. Review the source ledger while the repository and contribution workflow are prepared.'
                sourceHref='/sources'
              />
            )}
          </Card>
