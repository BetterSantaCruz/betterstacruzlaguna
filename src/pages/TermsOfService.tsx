            ...
            <div className='text-kapwa-text-support space-y-4 leading-relaxed'>
              ...
              <div className='border-kapwa-border-weak bg-kapwa-bg-surface-raised rounded-lg border p-4'>
                ...
                {config.portal.contactEmail ? (
                  ...
                  <DataStatus
                    title='Content reporting channel not published yet'
                    message='No verified public contact email is configured. Keep the page URL and supporting evidence available until a reviewed reporting channel is published.'
                    sourceHref='/sources'
                  />
                )}
          ...
          <section className='border-t pt-8'>
            ...
            <div className='bg-kapwa-bg-surface border-kapwa-border-brand rounded-lg border p-6'>
              <p className='text-kapwa-text-brand-bold mb-2'>
                For questions about these terms or content concerns, use the
                published project contact channel when one is available.
              </p>
              {config.portal.contactEmail ? (
                ...
                <p className='text-kapwa-text-brand-bold text-xl font-semibold'>
                  No public contact channel published yet.
                </p>
              )}
