...
const SearchPage: FC = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-8 md:py-12'>
      <Helmet>
        <title>Search | BetterSantaCruz</title>
        <meta
          name='description'
          content='Search reviewed civic information for Santa Cruz, Laguna.'
        />
      </Helmet>
              ...
              <EmptyState
                ...
                message={
                  query
                    ...
                    : typeFilter || categoryFilter
                      ? 'No reviewed service records match the selected filters.'
                      : 'No reviewed service records are indexed yet.'
                }
                icon={SearchIcon}
                actionLabel={
