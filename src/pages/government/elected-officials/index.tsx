...
export default function ElectedOfficialsPage() {
  ...
  if (electedLeaders.length === 0 && !sbData) {
    return (
      <div className='space-y-8'>
        ...
        />
        <DataStatus
          message='Do not infer current officials from old pages, search snippets, or another municipality. A dated first-party source is required.'
          sourceHref='/sources'
        />
      </div>
    );
