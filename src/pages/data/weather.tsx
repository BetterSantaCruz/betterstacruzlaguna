      ...
      <div className='bg-kapwa-bg-surface-raised min-h-screen'>
        <div className='container mx-auto px-4 py-8 md:py-12'>
          <DataStatus
            ...
            message='BetterSantaCruz does not publish live weather data yet. Use PAGASA for official advisories and check the source ledger for the current evidence boundary.'
            sourceHref='/sources'
          />
        </div>
      </div>
