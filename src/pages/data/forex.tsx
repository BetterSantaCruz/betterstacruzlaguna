    ...
    return (
      <div className='bg-kapwa-bg-surface-raised min-h-screen'>
        <div className='container mx-auto px-4 py-8 md:py-12'>
          <DataStatus
            title='Exchange-rate data is not configured'
            message='BetterSantaCruz does not publish a live forex feed. This utility remains disabled until a reviewed provider and freshness policy are documented.'
            sourceHref='/sources'
          />
        </div>
      </div>
