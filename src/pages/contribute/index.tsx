...
const GITHUB_ISSUE_URL = config.portal.githubUrl
...
export default function ContributePage() {
  return (
    <div className='animate-in fade-in mx-auto max-w-4xl space-y-8 px-4 pb-20 duration-500 md:px-0'>
      ...
      <ModuleHeader
        title='Contribute to BetterSantaCruz'
      ...
      <div className='grid grid-cols-1 gap-8 md:grid-cols-2'>
        <div className='space-y-6'>
          <div className='space-y-3'>
            ...
            <ol className='text-kapwa-text-support space-y-3 text-sm leading-relaxed'>
              <li className='flex gap-3'>
                ...
                <span>
                  When the public repository is available, use its contribution
                  form. You&apos;ll need a free GitHub account.
                </span>
              </li>
              <li className='flex gap-3'>
                <span className='bg-kapwa-bg-brand-default text-kapwa-text-inverse flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs font-bold'>
          ...
          {GITHUB_ISSUE_URL ? (
            ...
            <DataStatus
              title='Contribution form not published yet'
              message='The public BetterSantaCruz repository and contribution form will be linked here after the local foundation passes review. Until then, do not treat this site as an official submission channel.'
              sourceHref='/sources'
            />
          )}
