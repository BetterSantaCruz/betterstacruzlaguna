...
This directory contains integration tests for the BetterSantaCruz API endpoint seams (Cloudflare Pages Functions).

The fixtures are synthetic architecture tests only. They are not Santa Cruz civic facts and must not be promoted to the public dataset.
...
const mockDb = mockEnv.BETTERSANTACRUZ_DB as MockD1Database;
